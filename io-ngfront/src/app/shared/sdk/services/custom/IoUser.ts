...
/**
 * Api services for the `IoUser` model.
 */
@Injectable()
export class IoUserApi extends BaseLoopBackApi {
  ...
  /**
   * Demandes accessTokens de ioUser.
   *
   * @param {any} id ioUser id
   *
   * @param {object} filter 
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/ioUsers" + "/:id";
   ...
   * call to {@link sdk.IoUser#login} or
   * {@link sdk.IoUser#getCurrent}. Return null when there
  ...
  /**
   * @name sdk.IoUser#isAuthenticated
   *
